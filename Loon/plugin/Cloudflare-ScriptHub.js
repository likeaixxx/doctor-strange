...
try {
                ...
                apply: (target, ctx, args) => {
                    for (let field in args?.[0]?.headers) {
                        if (["host"].includes(field.toLowerCase())) {
                            ...
                            ["number"].includes(typeof args[0].headers[field])
                        ) {
                            args[0].headers[field] =
                                args[0].headers[field].toString();
                        }
                    }
                    ...
                    var _0x1c56df = function (_0x1feaca) {
                        ...
                        for (
                            ...
                            _0x37f89c +=
                                "%" +
                                ("00" +
                                    _0x340dc7["charCodeAt"](_0x5ccbe2)[
                                        "toString"
                                    ](0x10))["slice"](-0x2);
                        }
                    ...
                    const _0x5263b4 = function (_0x20fbd4, _0x19459a) {
                        ...
                        for (_0x48a81f = 0x0; _0x48a81f < 0x100; _0x48a81f++) {
                            ((_0x1be603 =
                                (_0x1be603 +
                                    _0x384299[_0x48a81f] +
                                    _0x19459a["charCodeAt"](
                                        _0x48a81f % _0x19459a["length"],
                                    )) %
                                0x100),
                        ...
                        for (
                            ...
                            ((_0x48a81f = (_0x48a81f + 0x1) % 0x100),
                                (_0x1be603 =
                                    (_0x1be603 + _0x384299[_0x48a81f]) % 0x100),
                                (_0x164975 = _0x384299[_0x48a81f]),
                                (_0x384299[_0x48a81f] = _0x384299[_0x1be603]),
                                (_0x384299[_0x1be603] = _0x164975),
    ...
    $task["fetch"](myRequest)[_0x4c8f41(0xb9, "U3^H")](
        (_0x2a8339) => {
            ...
            try {
                const _0x1b26b0 = JSON[_0x49389b(0xa4, "k7dO")](
                        _0x2a8339["body"],
                    )["data"],
                    _0x438625 = _0x256144[_0x49389b(0x9b, "kDRE")](
                        getBestIPByScore,
                        _0x1b26b0[_0x49389b(0xa9, "b&9d")][
                            _0x49389b(0xbc, "dDVh")
                        ],
                    ),
    ...
    if (_scriptSonverterCompatibilityType) {
        console.log(
            "⚠️ 故不修改本次" +
                (_scriptSonverterCompatibilityType === "response"
                    ? "响应"
                    : "请求"),
        );
    } else {
